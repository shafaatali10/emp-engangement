...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPTOPICLOOKUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPTOPICLOOKUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPTOPICLOOKUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPTOPICLOOKUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPTOPICLOOKUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPTOPICLOOKUP actions', async () => {
      const arg = 42666;
