...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPUSERGROUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPUSERGROUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPUSERGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPUSERGROUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPUSERGROUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPUSERGROUP actions', async () => {
      const arg = 42666;
