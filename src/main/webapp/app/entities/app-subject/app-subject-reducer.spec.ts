...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPSUBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPSUBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPSUBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPSUBJECT actions', async () => {
      const arg = 42666;
