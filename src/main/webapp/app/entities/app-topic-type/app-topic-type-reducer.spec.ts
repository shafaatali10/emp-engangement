...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPTOPICTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPTOPICTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPTOPICTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPTOPICTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPTOPICTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPTOPICTYPE actions', async () => {
      const arg = 42666;
