...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPSUBJECTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPSUBJECTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPSUBJECTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPSUBJECTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPSUBJECTTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPSUBJECTTYPE actions', async () => {
      const arg = 42666;
