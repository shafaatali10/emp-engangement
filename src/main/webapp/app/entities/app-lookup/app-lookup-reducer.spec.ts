...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLOOKUP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPLOOKUP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPLOOKUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPLOOKUP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPLOOKUP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPLOOKUP actions', async () => {
      const arg = 42666;
