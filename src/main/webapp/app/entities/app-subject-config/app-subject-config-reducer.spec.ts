...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './app-subject-config.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPSUBJECTCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPSUBJECTCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPSUBJECTCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPSUBJECTCONFIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPSUBJECTCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPSUBJECTCONFIG actions', async () => {
      const arg = 42666;
